...
# Call the function with parameter 10
...
# Bonus: You can also use the mathematical formula n * (n + 1) / 2
def sum_numbers_formula(n):
    """More efficient version using the mathematical formula"""
    return n * (n + 1) // 2

print(f"\nUsing formula for n=10: {sum_numbers_formula(10)}")